  ...
  return (
    <>
      <form className="mt-8 mb-2">
        <div className="mb-1 grid grid-cols-12  gap-6">
          ...
          <div className="col-span-12">
            ...
            <div className="w-full ">
              <Textarea
                placeholder="message"
                variant="outlined"
                className="h-[180px] !border-[rgb(171_199_243/80%)] after:!border-red-500 !text-[#bcd2f5] peer-focus:after:!border-red-900"
              />
            </div>
          </div>
